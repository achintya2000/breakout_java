...
/**
 * Purpose: The Sprite class is the top class in my hierarchy. It extends ImageView and I chose to do this because
 ...
 * Assumptions: We assume in other classes the input to the constructors are passed properly (like files) or else the
 * object will fail to initialize.
 * Depends on ImageView.
 * Ex: This is used as a parent class to other objects that extend on its functionality. If you have something
 * that you want to display in a scene, create a class that extends Sprite.
 */
